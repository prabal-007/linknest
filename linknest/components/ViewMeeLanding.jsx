        ...
        <div className="min-h-screen rounded-full flex flex-col items-center justify-center p-6 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] ]">
            <div className='flex justify-center items-center w-full'>
                ...
                <div className='flex flex-col justify-center items-center p-5'>
                    ...
                    <ul className=" text-gray-100 font-mono font-normal text-xl text-wrap flex flex-col w-[90%] justify-center items-center gap-2 mb-6 animate-tracking-in-expand">
...
const View1 = () => {
    return (<>
        <h2 className="text-2xl shadow-md text-yellow-400 font-semibold">Be seen. Be remembered. Be ViewMee</h2>
        <div className="max-w-fit w-full bg-gray-900 text-white shadow-md drop-shadow-xl shadow-yellow-300 rounded-2xl p-4 px-8 m-4">
            <div className="flex flex-col items-center gap-4">
                <p className="">Sign up for free and get your personalized ViewMee live in minutes at <a href='/' className="text-yellow-400 hover:underline">viewmee.live</a>.</p>
            ...
            <p className="text-center mt-6 font-mono font-thin">Your story deserves a better view.</p>
        </div>
    </>
    );
}
